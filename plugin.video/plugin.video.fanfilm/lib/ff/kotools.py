...
class Notification:
    ...
    def _update_end_time(self, interval: Optional[float] = None) -> None:
    ...
    def show(self, *, message: Optional[str] = None, icon: Optional[str] = None, **kwargs: Unpack[NotificationOpenArgs]) -> Self:
